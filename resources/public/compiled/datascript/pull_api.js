...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__23912 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__23912,kvps);
} else {
return G__23912;
}
})());
...
var depth = cljs.core.get.call(null,map__23915__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__23915__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__23918 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__23918__$1 = (((G__23918 == null))?null:cljs.core.persistent_BANG_.call(null,G__23918));
if((G__23918__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__23918__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__23919){
var vec__23922 = p__23919;
var frame = cljs.core.nth.call(null,vec__23922,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23922,(1));
...
var or__18418__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__23923 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__23923,kvps);
} else {
return G__23923;
}
})();
...
var recursion = cljs.core.get.call(null,map__23926__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__23926__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_23928 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_23928){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_23928,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_23928))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__23930){
var vec__23936 = p__23930;
var parent = cljs.core.nth.call(null,vec__23936,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23936,(1));
...
var found = cljs.core.not_empty.call(null,(function (){var G__23937 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__23937);
} else {
return G__23937;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23936,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23936,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23936,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23936,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__18406__auto__ = component_QMARK_;
...
var as_value = (function (){var G__23938 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__23938,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__23936,parent,frames){
return (function (p1__23929_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__23929_SHARP_]);
});})(G__23938,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__23936,parent,frames))
,G__23938);
} else {
return G__23938;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__23939 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__23939);
} else {
return G__23939;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__23940 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__23940,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__23940;
}
})());
...
var vec__23942 = spec;
var attr_key = cljs.core.nth.call(null,vec__23942,(0),null);
var opts = cljs.core.nth.call(null,vec__23942,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__23943){
var vec__23944 = p__23943;
var k = cljs.core.nth.call(null,vec__23944,(0),null);
var v = cljs.core.nth.call(null,vec__23944,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__23945){
var vec__23947 = p__23945;
var frame = cljs.core.nth.call(null,vec__23947,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23947,(1));
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__18418__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__18418__auto__)){
return or__18418__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__23948){
var vec__23951 = p__23948;
var frame = cljs.core.nth.call(null,vec__23951,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23951,(1));
...
var vec__23952 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__23952,(0),null);
var datoms = cljs.core.nth.call(null,vec__23952,(1),null);
...
var map__23956 = frame;
var map__23956__$1 = ((((!((map__23956 == null)))?((((map__23956.cljs$lang$protocol_mask$partition0$ & (64))) || (map__23956.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23956):map__23956);
var attr = cljs.core.get.call(null,map__23956__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__23956__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__23958 = recursion;
if(cljs.core.some_QMARK_.call(null,attr)){
return datascript.pull_api.push_recursion.call(null,G__23958,attr,eid);
} else {
return G__23958;
}
})();
...
var map__23961 = frame;
var map__23961__$1 = ((((!((map__23961 == null)))?((((map__23961.cljs$lang$protocol_mask$partition0$ & (64))) || (map__23961.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23961):map__23961);
var eid = cljs.core.get.call(null,map__23961__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__23961__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__18418__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__18418__auto__)){
return or__18418__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__23963){
while(true){
var vec__23965 = p__23963;
var frame = cljs.core.nth.call(null,vec__23965,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23965,(1));
var temp__4655__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4655__auto__){
var eids = temp__4655__auto__;
...
var G__23966 = db;
var G__23967 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__23966;
p__23963 = G__23967;
continue;
}
...
while(true){
var G__23972 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__23972) {
case "expand":
var G__23977 = db;
var G__23978 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__23977;
frames = G__23978;
continue;
...
case "expand-rev":
var G__23979 = db;
var G__23980 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__23979;
frames = G__23980;
continue;
...
case "pattern":
var G__23981 = db;
var G__23982 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__23981;
frames = G__23982;
continue;
...
case "recursion":
var G__23983 = db;
var G__23984 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__23983;
frames = G__23984;
continue;
...
break;
case "done":
var vec__23973 = frames;
var f = cljs.core.nth.call(null,vec__23973,(0),null);
var remaining = cljs.core.nthnext.call(null,vec__23973,(1));
var result = (function (){var G__23974 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__23974);
} else {
return G__23974;
}
})();
...
var G__23985 = db;
var G__23986 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__23975 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__23975,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__23975;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__23987_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__23987_SHARP_);
})),eids);
