...
goog.provide('yizhackclj.components.button_form');
goog.require('cljs.core');
goog.require('reagent.core');
goog.require('yizhackclj.db');
goog.require('yizhackclj.state');
goog.require('yizhackclj.components.button');
yizhackclj.components.button_form.button_form = (function yizhackclj$components$button_form$button_form(){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.edit","div.edit",1748816207),(cljs.core.truth_((function (){var and__18406__auto__ = cljs.core.deref.call(null,yizhackclj.state.edit_mode);
if(cljs.core.truth_(and__18406__auto__)){
return cljs.core.deref.call(null,yizhackclj.state.selected_button);
} else {
return and__18406__auto__;
}
})())?(function (){var button = yizhackclj.db.button.call(null,new cljs.core.Keyword(null,"layer-id","layer-id",576786958).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,yizhackclj.state.selected_button)),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,yizhackclj.state.selected_button)),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,yizhackclj.state.selected_button)));
...
return yizhackclj.db.button_update.call(null,button,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),e.target.value], null));
...
return yizhackclj.db.button_update.call(null,button,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),[cljs.core.str("LN_"),cljs.core.str(e.target.value)].join('')], null));
} else {
return null;
}
});})(button,layers_select_value,control_select_value))
...
return (function yizhackclj$components$button_form$button_form_$_iter__38625(s__38626){
return (new cljs.core.LazySeq(null,((function (button,layers_select_value,control_select_value){
return (function (){
var s__38626__$1 = s__38626;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__38626__$1);
if(temp__4657__auto__){
var s__38626__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__38626__$2)){
var c__19196__auto__ = cljs.core.chunk_first.call(null,s__38626__$2);
var size__19197__auto__ = cljs.core.count.call(null,c__19196__auto__);
var b__38628 = cljs.core.chunk_buffer.call(null,size__19197__auto__);
if((function (){var i__38627 = (0);
while(true){
if((i__38627 < size__19197__auto__)){
var layer = cljs.core._nth.call(null,c__19196__auto__,i__38627);
cljs.core.chunk_append.call(null,b__38628,(function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(layer);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38628),yizhackclj$components$button_form$button_form_$_iter__38625.call(null,cljs.core.chunk_rest.call(null,s__38626__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__38628),null);
}
} else {
var layer = cljs.core.first.call(null,s__38626__$2);
...
var name = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(layer);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),id], null),name], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),yizhackclj$components$button_form$button_form_$_iter__38625.call(null,cljs.core.rest.call(null,s__38626__$2)));
}
} else {
return null;
}
