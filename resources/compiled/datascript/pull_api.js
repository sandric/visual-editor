...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__24977 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__24977,kvps);
} else {
return G__24977;
}
})());
...
var depth = cljs.core.get.call(null,map__24980__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__24980__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__24983 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__24983__$1 = (((G__24983 == null))?null:cljs.core.persistent_BANG_.call(null,G__24983));
if((G__24983__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__24983__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__24984){
var vec__24987 = p__24984;
var frame = cljs.core.nth.call(null,vec__24987,(0),null);
var frames = cljs.core.nthnext.call(null,vec__24987,(1));
...
var results = (function (){var G__24988 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__24988,kvps);
} else {
return G__24988;
}
})();
...
var recursion = cljs.core.get.call(null,map__24991__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__24991__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_24993 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_24993){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_24993,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_24993))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__24995){
var vec__25001 = p__24995;
var parent = cljs.core.nth.call(null,vec__25001,(0),null);
var frames = cljs.core.nthnext.call(null,vec__25001,(1));
...
var found = cljs.core.not_empty.call(null,(function (){var G__25002 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__25002);
} else {
return G__25002;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__25001,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__25001,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__25001,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__25001,parent,frames))
);
...
var as_value = (function (){var G__25003 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__25003,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__25001,parent,frames){
return (function (p1__24994_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__24994_SHARP_]);
});})(G__25003,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__25001,parent,frames))
,G__25003);
} else {
return G__25003;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__25004 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__25004);
} else {
return G__25004;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__25005 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__25005,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__25005;
}
})());
...
var vec__25007 = spec;
var attr_key = cljs.core.nth.call(null,vec__25007,(0),null);
var opts = cljs.core.nth.call(null,vec__25007,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__25008){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__25010){
var vec__25012 = p__25010;
var frame = cljs.core.nth.call(null,vec__25012,(0),null);
var frames = cljs.core.nthnext.call(null,vec__25012,(1));
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__25013){
var vec__25016 = p__25013;
var frame = cljs.core.nth.call(null,vec__25016,(0),null);
var frames = cljs.core.nthnext.call(null,vec__25016,(1));
...
var vec__25017 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__25017,(0),null);
var datoms = cljs.core.nth.call(null,vec__25017,(1),null);
...
var attr = cljs.core.get.call(null,map__25021__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__25021__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__25023 = recursion;
if(cljs.core.some_QMARK_.call(null,attr)){
return datascript.pull_api.push_recursion.call(null,G__25023,attr,eid);
} else {
return G__25023;
}
})();
...
var eid = cljs.core.get.call(null,map__25026__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__25026__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__25028){
while(true){
var vec__25030 = p__25028;
var frame = cljs.core.nth.call(null,vec__25030,(0),null);
var frames = cljs.core.nthnext.call(null,vec__25030,(1));
var temp__4655__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4655__auto__){
var eids = temp__4655__auto__;
...
var G__25031 = db;
var G__25032 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__25031;
p__25028 = G__25032;
continue;
}
...
while(true){
var G__25037 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__25037) {
case "expand":
var G__25042 = db;
var G__25043 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__25042;
frames = G__25043;
continue;
...
case "expand-rev":
var G__25044 = db;
var G__25045 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__25044;
frames = G__25045;
continue;
...
case "pattern":
var G__25046 = db;
var G__25047 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__25046;
frames = G__25047;
continue;
...
case "recursion":
var G__25048 = db;
var G__25049 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__25048;
frames = G__25049;
continue;
...
break;
case "done":
var vec__25038 = frames;
var f = cljs.core.nth.call(null,vec__25038,(0),null);
var remaining = cljs.core.nthnext.call(null,vec__25038,(1));
var result = (function (){var G__25039 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__25039);
} else {
return G__25039;
}
})();
...
var G__25050 = db;
var G__25051 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__25040 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__25040,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__25040;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__25052_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__25052_SHARP_);
})),eids);
