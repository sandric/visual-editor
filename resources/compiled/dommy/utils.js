 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__26043){
var vec__26045 = p__26043;
var k = cljs.core.nth.call(null,vec__26045,(0),null);
var ks = cljs.core.nthnext.call(null,vec__26045,(1));
...
return [cljs.core.str((function (){var G__26047 = cljs.core.namespace.call(null,s);
if((G__26047 == null)){
return null;
} else {
return [cljs.core.str(G__26047),cljs.core.str("/")].join('');
}
...
var G__26049 = (function (){var end = (i + class$.length);
