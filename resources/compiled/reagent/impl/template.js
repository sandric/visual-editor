...
var G__23288 = o;
(G__23288[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__23296 = jsprops;
(G__23296["defaultValue"] = value);

(G__23296["onChange"] = ((function (G__23296,v,value,on_change){
return (function (p1__23294_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23294_SHARP_);
});})(G__23296,v,value,on_change))
);
...
var vec__23301 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23301,(0),null);
var id = cljs.core.nth.call(null,vec__23301,(1),null);
var class$ = cljs.core.nth.call(null,vec__23301,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___23304 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___23304 == null)){
} else {
var key_23305 = temp__4661__auto___23304;
(jsprops["key"] = key_23305);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23307 = (new reagent.impl.template.NativeWrapper());
(G__23307["name"] = c);
...
var len__19487__auto___23313 = arguments.length;
var i__19488__auto___23314 = (0);
while(true){
if((i__19488__auto___23314 < len__19487__auto___23313)){
args__19494__auto__.push((arguments[i__19488__auto___23314]));

var G__23315 = (i__19488__auto___23314 + (1));
i__19488__auto___23314 = G__23315;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23311){
var G__23312 = cljs.core.first.call(null,seq23311);
var seq23311__$1 = cljs.core.next.call(null,seq23311);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23312,seq23311__$1);
});
...
break;
default:
var G__23319 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23319;
continue;
...
var n__19332__auto___23320 = a.length;
var i_23321 = (0);
while(true){
if((i_23321 < n__19332__auto___23320)){
(a[i_23321] = reagent.impl.template.as_element.call(null,(a[i_23321])));

var G__23322 = (i_23321 + (1));
i_23321 = G__23322;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19332__auto___23323 = a.length;
var i_23324 = (0);
while(true){
if((i_23324 < n__19332__auto___23323)){
var val_23325 = (a[i_23324]);
if((cljs.core.vector_QMARK_.call(null,val_23325)) && ((reagent.impl.template.key_from_vec.call(null,val_23325) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23324] = reagent.impl.template.as_element.call(null,val_23325));
...
var ctx = {};
var vec__23328 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23328,(0),null);
var derefed = cljs.core.nth.call(null,vec__23328,(1),null);
...
var G__23330 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23330) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23330){
